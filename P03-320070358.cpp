...
int main()
{
	...
	*/
	...
	// El que manipularemos es el movement speed y trun speed 
	...
	while (!mainWindow.getShouldClose())
	{
		...
		uniformColor = shaderList[0].getColorLocation();
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.38f, -4.17f));
		model = glm::rotate(model, 0 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f)); // x
		model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));  // y 
		model = glm::rotate(model, 0 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f)); // Z;
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA y se envían al shader como variables de tipo uniform
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		uniformColor = shaderList[0].getColorLocation();
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.30f, -0.38f, -3.88f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA y se envían al shader como variables de tipo uniform
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		uniformColor = shaderList[0].getColorLocation();
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.38f, -3.88f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA y se envían al shader como variables de tipo uniform
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		uniformColor = shaderList[0].getColorLocation();
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.15f, -0.38f, -3.95f));
		model = glm::rotate(model, 0 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f)); // x
		model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));  // y 
		model = glm::rotate(model, 0 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f)); // Z;
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
